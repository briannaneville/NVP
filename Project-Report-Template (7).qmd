...
The response variable we are investigating is non-linear viscous parameter. There parameters we used in our model are listed below.
...
Information on non-linear viscoelasticity: "Creep and fatigue of natural fibre composites" by M. Misra, S.S. Ahankari, and A.K. Mohanty. https://www.sciencedirect.com/science/article/abs/pii/B9781845697426500113 
...
### R Script
```{r ref.label=c('front-matter', 'fig-example1','tbl-summarystats', 'fig-example2', 'model-code', 'tbl-fixed-effects', 'tbl-random-effects', 'fig-model-predictions')}
#| echo: true
#| eval: false
